    ...
    <section className="relative overflow-hidden bg-background">
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Comprehensive testing platform for modern web applications. Run automated tests,
              monitor performance, and ensure quality across all your projects.
            </p>
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Test Site dashboard showing automated testing results and analytics"
                  fill
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
          <div className="relative max-w-4xl mx-4 bg-card rounded-lg shadow-2xl">
            <button
              onClick={() => setIsModalOpen(false)}
              className="absolute -top-4 -right-4 bg-background rounded-full p-2 shadow-lg hover:bg-muted"
            >
              ✕
            </button>
